...
mod tests {
    ...
    fn md5_32bytes() {
        ...
        assert_eq!(
            hash,
            [
                0x69, 0xca, 0x36, 0x72, 0x1d, 0xd0, 0x20, 0x97, 0x82, 0xc3, 0x76, 0x17, 0xf2, 0x20,
                0xab, 0x82
            ]
        );
    }
    ...
    fn md5_64bytes() {
        ...
        assert_eq!(
            hash,
            [
                0x6f, 0xbe, 0xd0, 0x7f, 0xcc, 0x87, 0x90, 0xb2, 0xcb, 0x56, 0x03, 0x02, 0xa5, 0xc7,
                0x5e, 0x56
            ]
        );
    }
    ...
    fn md5_128bytes() {
        ...
        assert_eq!(
            hash,
            [
                0x59, 0xa4, 0x18, 0xec, 0xcd, 0xff, 0x43, 0xeb, 0xfa, 0xb1, 0x63, 0x91, 0x6c, 0x60,
                0x2c, 0x15
            ]
        );
    }
    ...
    fn md5_256bytes() {
        ...
        assert_eq!(
            hash,
            [
                0xe5, 0x0b, 0xe7, 0x33, 0x07, 0x72, 0xe0, 0x89, 0xf6, 0x5e, 0x0e, 0xfd, 0x98, 0x69,
                0xc9, 0xe3
            ]
        );
    }
