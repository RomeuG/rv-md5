...
fn rotate_left_avx2(x: __m256i, n: i32) -> __m256i {
    ...
    let right = constify_imm8!(n, srli);

    unsafe { _mm256_or_si256(left, right) }
}

#[inline(always)]
fn md5_f_avx2(x: __m256i, y: __m256i, z: __m256i) -> () {}
fn md5_g_avx2(x: __m256i, y: __m256i, z: __m256i) -> () {}
fn md5_h_avx2(x: __m256i, y: __m256i, z: __m256i) -> () {}
fn md5_i_avx2(x: __m256i, y: __m256i, z: __m256i) -> () {}
